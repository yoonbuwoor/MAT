...
const projectTemplates = <ProjectTemplate>[
  ProjectTemplate(
    title: 'Carte thématique',
    description: 'Transformer une donnée en message cartographique clair.',
    icon: Icons.map_rounded,
    steps: [
      'Définir la question cartographique',
      'Contrôler et nettoyer les données',
      'Choisir la méthode de représentation',
      'Construire une hiérarchie visuelle',
      'Ajouter les éléments indispensables',
      'Relire et exporter',
    ],
  ),
  ProjectTemplate(
    title: 'Étude SIG',
    description: 'Organiser une analyse spatiale complète et justifiable.',
    icon: Icons.hub_outlined,
    steps: [
      'Formuler la problématique',
      'Lister les données nécessaires',
      'Définir les critères et indicateurs',
      'Préparer les géotraitements',
  ...
  ProjectTemplate(
    ...
    description: 'Passer du sujet de recherche à une méthodologie géomatique.',
    icon: Icons.school_outlined,
    steps: [
      'Délimiter le sujet et la zone',
      'Construire la problématique',
      'Définir objectifs et hypothèses',
      'Choisir données et méthodes',
      'Planifier terrain et traitements',
      'Organiser résultats et discussion',
    ],
  ),
  ProjectTemplate(
    title: 'Collecte de terrain',
    description: 'Préparer une mission simple, traçable et exploitable.',
    icon: Icons.location_searching,
    steps: [
      'Définir les objets à observer',
      'Créer les champs de collecte',
      'Choisir le système de coordonnées',
      'Tester le formulaire',
      'Collecter avec contrôle qualité',
...
const glossary = <String, String>{
  'Azimut': 'Angle horizontal mesuré depuis le nord vers une direction donnée.',
  'Datum': 'Référence géodésique utilisée pour définir la position des coordonnées sur la Terre.',
  'Géocodage': 'Transformation d’une adresse ou d’un nom de lieu en coordonnées géographiques.',
  'Géométrie': 'Forme spatiale d’un objet : point, ligne, polygone ou cellule raster.',
  'MNT': 'Modèle numérique décrivant principalement l’altitude du terrain.',
  'MNS': 'Modèle numérique représentant la surface incluant bâtiments et végétation.',
  'Orthophoto': 'Image aérienne corrigée géométriquement afin de permettre des mesures.',
  'Résolution spatiale': 'Dimension au sol représentée par un pixel dans une image raster.',
  'Shapefile': 'Ancien format vectoriel composé de plusieurs fichiers associés.',
  'Topologie': 'Règles décrivant les relations spatiales entre les objets.',
};
